...
export const cancelHandler = (e:React.MouseEvent, setSearch:setSearchType, 
...
export const deleteTargetHandler = (e:React.MouseEvent, obj:ObjType, 
    setSelectedObj: setSelectType, selectedObj:[] | ObjType[])=>{
    e.stopPropagation()
